...
orders_and_payments AS (
    SELECT
        ...
        (
            days_to_deliver_customer - estimated_days_to_deliver_customer
        ) AS estimation_delivery_days_diff,
        estimation_delivery_days_diff > 0 AS is_delivery_late,
        CASE
            ...
            WHEN is_delivery_late
                THEN 'Minor'
            WHEN NOT is_delivery_late
                THEN 'On-time'
            ELSE is_delivery_late
